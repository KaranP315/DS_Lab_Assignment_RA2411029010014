...
- `setup_datasets.py`: Generates the mock CSV datasets for testing.
- `retail_sales.csv`: Dataset for Question 1.
- `employee_master.csv`: Dataset for Question 2.
- `student_personal.csv`: Dataset for Question 6.
- `exam_scores.csv`: Dataset for Question 6.
